...
function Switch({
  ...
  return (
    <SwitchPrimitive
      className={cn(
        "relative peer focus-visible:border-ring focus-visible:ring-ring/50 flex h-5 w-10 px-px shrink-0 items-center justify-start rounded-full border border-transparent shadow-xs outline-none focus-visible:ring-[3px] disabled:cursor-not-allowed disabled:opacity-50",
